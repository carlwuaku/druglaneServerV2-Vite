      ...
      <div className="flex flex-column justify-content-center align-items-center">
          ...
          <form onSubmit={formik.handleSubmit} className="flex flex-column gap-3">
              ...
              <div className="flex flex-column gap-2">
                  ...
                  <InputText id="receipt_font_size"
              ...
              <div className="flex flex-column gap-2">
                  ...
                  <SelectButton
                      ...
                      className={classNames('flex justify-content-center', { 'p-invalid': formik.errors.show_tax_on_receipt })}
                  />
              ...
              <div className="flex flex-column gap-2">
                  ...
                  <SelectButton
                      ...
                      className={classNames('flex justify-content-center', { 'p-invalid': formik.errors.receipt_logo })}
                  />
              ...
              <div className="flex flex-column gap-2">
                  ...
                  <SelectButton
                      ...
                      className={classNames('flex justify-content-center', { 'p-invalid': formik.errors.receipt_show_borders })}
                  />
              ...
              <div className="flex flex-column gap-2">
                  ...
                  <SelectButton
                      ...
                      className={classNames('flex justify-content-center', { 'p-invalid': formik.errors.receipt_show_customer })}
                  />
                  <small id="show_tax_on_receipt-help">
              ...
              <div className="flex flex-column gap-2">
                  ...
                  <SelectButton
                      ...
                      className={classNames('flex justify-content-center', { 'p-invalid': formik.errors.receipt_show_credits })}
                  />
              ...
              <div className="flex flex-column gap-2">
                  ...
                  <InputText id="receipt_extra_info"
